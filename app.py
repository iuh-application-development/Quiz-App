...
class UserProfile(db.Model):
    ...
    # Define the relationship to User with a backref that sets up User.profile as one-to-one
...
def search_quiz():
    ...
    for quiz in quizzes:
        ...
        profile = teacher.profile # Access the profile directly (assuming one-to-one)
